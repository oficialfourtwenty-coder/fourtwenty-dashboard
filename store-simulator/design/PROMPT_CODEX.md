# Traspaso actual para Codex o Claude Code

Este texto reemplaza el prompt antiguo de tareas de assets. Antes de trabajar,
leer completo `/Users/kusher/Desktop/fourtwenty-dashboard/CLAUDE.md`.
...
3. Trabajar en un solo bloque verificable.
4. Conservar posiciones y cambios del World Editor.
5. Medir peso agregado y carga.
